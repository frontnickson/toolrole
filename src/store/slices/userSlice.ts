...
const userSlice = createSlice({
  ...
  reducers: {
    ...
    clearCurrentUser: (state) => {
      console.log('🔐 userSlice: clearCurrentUser - очистка данных пользователя');
      ...
      console.log('🔐 userSlice: Данные пользователя очищены');
    },

    // Обновление профиля пользователя
    updateUserProfile: (state, action: PayloadAction<Partial<ExtendedUser>>) => {
      if (state.currentUser) {
        console.log('🔐 userSlice: updateUserProfile - обновление профиля:', action.payload);
        ...
        console.log('🔐 userSlice: Профиль обновлен');
      }
    },

    // Установка временных данных (для форм)
    setTempUserData: (state, action: PayloadAction<Partial<ExtendedUser>>) => {
      console.log('🔐 userSlice: setTempUserData - установка временных данных:', action.payload);
    ...
    clearTempUserData: (state) => {
      console.log('🔐 userSlice: clearTempUserData - очистка временных данных');
    ...
    createNewUser: (state, action: PayloadAction<{ email: string; username: string; password?: string }>) => {
      ...
      console.log('🔐 userSlice: createNewUser - создание нового пользователя:', { email, username });
      ...
      console.log('🔐 userSlice: Новый пользователь создан:', newUser);
    },
  },
});
